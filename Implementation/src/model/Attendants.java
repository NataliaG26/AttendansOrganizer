...
public class Attendants {
	...
	private int id;
	private Attendants next;
	private Attendants before;
	private Attendants left;
	private Attendants right;
	...
	public Attendants getBefore() {
		return before;
	}
	public void setBefore(Attendants before) {
		this.before = before;
	}
